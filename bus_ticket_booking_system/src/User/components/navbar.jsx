          ...
          {isLoggedIn && (
            <>
              <li className="nav-item me-3">
                <Link className="nav-link text-white" to="/user/home">Home</Link>
              </li>
              <li className="nav-item me-3">
                <Link className="nav-link text-white" to="/user/viewticket">View Ticket</Link>
              </li>
              <li className="nav-item me-3">
                <Link className="nav-link text-white" to="/user/cancelticket">Cancel Ticket</Link>
              </li>
              <li className="nav-item me-3">
                <Link className="nav-link text-white" to="/user/mybookings">My Bookings</Link>
              </li>
              <li className="nav-item me-3">
                <Link className="nav-link text-white" to="/user/viewbuses">View Buses</Link>
              </li>
              <li className="nav-item me-3">
